...
def generate(name=NAME, images_to_generate=IMAGES_TO_GENERATE, use_mapper=True, truncation_trick=1.0):
    ...
    for i in range(images_to_generate):
        ...
        generated_images, average_generated_images = model.evaluate(
            use_mapper=use_mapper, truncation_trick=truncation_trick
        )
